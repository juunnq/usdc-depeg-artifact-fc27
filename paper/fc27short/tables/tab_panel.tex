...
\begin{tabular}{@{}p{1.2cm} p{2.1cm} p{1.05cm} p{1.05cm} p{2.3cm} p{1.05cm} p{0.75cm} p{1.1cm}@{}}
\toprule
...
Tether 2019 [a] &
  ...
  $[0.135,\allowbreak 0.174]$ & No & $[0.214,\allowbreak 0.288]$ \\
USDT, Terra episode (May 2022), not counted [b] &
  no disclosure &
  0.00 & 1.00 &
  composite: \$0.993 &
  -- & Yes & $-0.007$ \\
